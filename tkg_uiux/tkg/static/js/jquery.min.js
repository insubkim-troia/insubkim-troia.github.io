...
function (a, b) {
        ...
        function Fa(a, b, c) {
            ...
            c && (
                ...
                !l.pixelMarginRight() && Ba.test(g) && Aa.test(b) && (
                    d = h.width,
                    e = h.minWidth,
                    f = h.maxWidth,
            ...
            .extend({
                ...
                n.extend(n.event, {
                    trigger: function (b, c, e, f) {
                        ...
                        if (
                            h = i = e = e || d,
                            3 !== e.nodeType && 8 !== e.nodeType && !hb.test(q + n.event.triggered) && (
                ...
                var lb = /#.*$/, mb = /([?&])_=[^&]*/, nb = /^(.*?):[ \t]*([^\r\n]*)$/gm, ob = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, pb = /^(?:GET|HEAD)$/, qb = /^\/\//, rb = {}, sb = {}, tb = "*/".concat(
                        "*"
