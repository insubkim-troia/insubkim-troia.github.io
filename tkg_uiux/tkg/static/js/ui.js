...
const common = {
  header: function () {
    ...
    $(document).on('mouseenter', '.gnb-wrap > .gnb-dep01 > li', function() {      
      $(this).find('.sub-depth-layer').show();      
    ...
    $(document).on('mouseleave', '.gnb-wrap > .gnb-dep01 > li', function() {
      $(this).find('.sub-depth-layer').hide();  
      $(this).removeClass('over');
    });

    $(document).on('click', '.gnb-wrap > .gnb-dep01 > li', function() {
    ...
    $(document).on('click', '.page-tit .btn-favorites', function() {
      $(this).toggleClass('on');
    });
  },
